...
\normalsize
\begin{itemize}
    \item Built probabilistic, deep computer vision, dose-planning models from segmented 3D CT scans.
    \item Learned latent anatomical representations using autoencoders.
    \item Validated modelling choices with clinicians and medical physicists.
\end{itemize}

{\footnotesize\textit{Keywords: deep learning, ML, probabilistic modelling, autoencoders, sparse Gaussian processes, optimisation, medical AI}}
...
\normalsize
\begin{itemize}
    \item Architecting and building a Databricks forecasting platform for pharmaceutical analytics.
    \item Owned a next-best-action engine and extended explainable AI features.
\end{itemize}

{\footnotesize\textit{Keywords: Databricks, explainable AI, forecasting}}
...
\begin{itemize}
    ...
    \item Led explainable AI and Git trainings; mentored junior data scientists.
    \item Presented complex technical topics to non-technical stakeholders.
\end{itemize}

{\footnotesize\textit{Keywords: deep learning, NLP, explainable AI, MLOps, stakeholder communication}}
...
\normalsize
\cvitem{Technology}{Python, SQL, C++, PyTorch, SHAP, XGBoost, Databricks, AWS, MS Azure, FastAPI, MongoDB, Qdrant, Docker.}
...
\cvitem{Other}{Valcon People's Choice Award (2023); Part of Team Sweden for IYPT 2015; Mensa Sweden.}
