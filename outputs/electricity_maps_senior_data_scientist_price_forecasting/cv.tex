...
Curious data scientist with seven years' experience applying machine learning across pharmaceutical analytics, healthcare, energy, manufacturing, and e-commerce. I bring a strong statistical background and hands-on experience with forecasting, production ML systems, probabilistic modelling, explainable AI, and stakeholder-facing model delivery.
...
\normalsize
\begin{itemize}
    \item Architecting a Databricks forecasting platform for pharmaceutical price and demand.
    \item Maintaining an XGBoost price forecast for Denmark's blind pharmaceutical auctions.
    \item Owned a next-best-action engine and extended explainable AI features with UX designers.
\end{itemize}

{\footnotesize\textit{Keywords: forecasting, Databricks, XGBoost, ML engineering, explainable AI, pricing, pharmaceutical analytics}}
...
\begin{itemize}
    ...
    \item Built a production real-time neural network using natural-language inputs.
    \item Mentored colleagues and led trainings in explainable AI and Git.
\end{itemize}

{\footnotesize\textit{Keywords: production ML, neural networks, MLOps, energy, explainable AI, stakeholder communication}}
...
\normalsize
\cvitem{Technology}{Python, SQL, C++, PyTorch, TensorFlow, SHAP, XGBoost, Facebook Prophet, MLflow, Databricks, AWS, MS Azure, FastAPI, Docker.}
