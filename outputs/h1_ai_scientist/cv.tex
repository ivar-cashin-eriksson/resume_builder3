...
I am a data scientist and ML engineer with seven years of experience across pharmaceutical analytics, healthcare AI, production ML, and applied research. I have built and maintained ML systems in Databricks and AWS, worked with natural-language inputs in production modelling, and developed clinical ML methods for radiotherapy planning. I am interested in H1's AI Scientist role because it combines healthcare data, NLP, and production-oriented model development.
...
\begin{itemize}
    ...
    \item Owned a pharmaceutical next-best-action engine and added explainable AI features.
    \item Maintains an XGBoost model for Denmark's pharmaceutical blind auctions.
\end{itemize}

{\footnotesize\textit{Keywords: pharmaceutical analytics, Databricks, XGBoost, forecasting, explainable AI, AWS}}
...
{\footnotesize\textit{Keywords: healthcare AI, clinical decision support, medical imaging, deep learning, probabilistic modelling}}
...
\normalsize
\begin{itemize}
    \item Architected a production real-time neural network using natural-language inputs.
...
\normalsize
\cvitem{Technology}{Python, SQL, C++, PyTorch, TensorFlow, SHAP, XGBoost, MLflow, Databricks, AWS, MS Azure, FastAPI, MongoDB, Qdrant, Docker.}
\cvitem{Methods}{Deep learning, NLP, forecasting, clustering, autoencoders, CNNs, sparse Gaussian processes, explainable AI, vector search.}
...
% ---------------------------
\phantomsection\label{sec:resume-builder}
\cventry{2023--Present}{Solo Project}{resume\_builder}{}{}{
    I maintain a structured system for generating tailored CVs and cover letters from profile data and job descriptions. The project uses YAML profile data, job-description parsing, and a template-based generation workflow, and has been a practical exercise in agentic prompting, system design, and applied NLP workflows.
}{}
