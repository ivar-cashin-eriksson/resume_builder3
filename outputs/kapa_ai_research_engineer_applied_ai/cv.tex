...
\normalsize
\begin{itemize}
    \item Building a source-grounded system for generating tailored application materials.
    \item Produces evidence mappings and gap reports to keep generated claims traceable to profile YAMLs.
    \item Runs job-hunter agent workflow from web crawling, to GitHub Actions, and automatic application materials.
\end{itemize}

{\footnotesize\textit{Keywords: Agentic workflows, source-grounded generation, human-in-the-loop automation, evidence mapping, GitHub Actions, Codex}}
...
\normalsize
\begin{itemize}
    \item Learned latent anatomical representations from segmented 3D CT scans for cancer treatment automation workflows using autoencoders.
    \item Predicted dose-volume histograms and spatial dose distributions using sparse Gaussian processes.
\end{itemize}

{\footnotesize\textit{Keywords: deep learning, representation learning, probabilistic modelling, sparse Gaussian processes, optimisation, medical AI}}
...
\normalsize
\begin{itemize}
    \item Architected, project managed, and built an in-production, real-time, deep neural network system using NLP, autoencoders, and transfer learning. 
    \item Led client projects from problem framing through model delivery and stakeholder alignment.
\end{itemize}

{\footnotesize\textit{Keywords: NLP, deep neural networks, production ML, explainable AI, stakeholder management, mentoring}}
...
\begin{itemize}
    ...
    \item Work as architect, data scientist, ML engineer, software engineer, and project manager.
\end{itemize}

{\footnotesize\textit{Keywords: LLM embeddings, search, explainable AI, Databricks, XGBoost, project management}}
...
\normalsize
\cvitem{Technology}{Python, SQL, PyTorch, TensorFlow, Scikit-learn, SHAP, OpenCLIP, MLflow, FastAPI, Docker, MongoDB, Qdrant, Databricks, AWS, MS Azure.}
\cvitem{Methods}{Deep learning, representation learning, embeddings, vector search, explainable AI.}
