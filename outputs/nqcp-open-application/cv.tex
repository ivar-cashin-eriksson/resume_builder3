...
Data scientist and ML engineer with seven years of applied experience and an academic background in Engineering Physics and Statistical Learning. My work has focused on numerical modelling, optimisation, probabilistic methods, and machine learning. I am interested in applying this background to challenging data-driven problems in quantum computing. 
...
\normalsize
\begin{itemize}
    \item Developed ML methods for automated radiotherapy planning from segmented 3D CT scans.
    \item Applied autoencoders, Gaussian processes, probabilistic modelling, and multi-objective optimisation.
    \item Translated clinical constraints into mathematical models in collaboration with medical physicists.
\end{itemize}
...
\normalsize
\begin{itemize}
    \item Leading development of a production forecasting platform for pharmaceutical prices and demand.
    \item Working across mathematical modelling, software architecture, data engineering, and ML engineering.
\end{itemize}
{\footnotesize\textit{Keywords: Explainable AI, Azure Databricks, forecasting, XGBoost, pricing, ML engineering, project management}}
...
\normalsize
\begin{itemize}
    \item Architected an end-to-end training and inference system for a real-time neural network.
    \item Led technical delivery across modelling, software architecture, and production deployment.
    \item Mentored data scientists in reproducibility, software design, explainable AI, and Git.
\end{itemize}
...
\cvitem{Modelling}{Optimisation, probabilistic modelling, sparse Gaussian processes, deep learning.}
\cvitem{Language}{\textit{Native}: English, Swedish. \textit{Intermediate}: Danish.}
\cvitem{Other}{Valcon People's Choice Award (2023); IYPT Sweden (2015); Mensa Sweden.}
