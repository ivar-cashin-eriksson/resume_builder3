...
{\footnotesize\textit{Keywords: method development, deep learning, probabilistic modelling, representation learning, numerical optimisation}}
...
\normalsize
\cvitem{Technology}{Python, PyTorch, TensorFlow, scikit-learn, SQL, Git, Linux, MLflow, Docker, Databricks}
\cvitem{Methods}{Representation learning, probabilistic modelling, sparse Gaussian processes, numerical optimisation, similarity learning, autoencoders, model evaluation}
