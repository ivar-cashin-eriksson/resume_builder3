...
Data Scientist and ML Engineer with seven years of experience developing and deploying machine-learning systems for complex real-world problems. I combine a strong foundation in engineering physics, mathematics, statistics, and deep learning with practical ownership of data pipelines, model evaluation, and production deployment. My work spans healthcare, pharmaceutical analytics, energy, IoT, and manufacturing, including safety-critical clinical applications and real-time ML systems.
...
\normalsize
\begin{itemize}
    \item Develop automated ML workflows for pharmaceutical forecasting, from data validation and training to experiment tracking and batch inference.
    \item Design maintainable ML architecture supporting thousands of independently trained models.
    \item Work with domain stakeholders to turn ambiguous operational needs into reliable data products.
\end{itemize}

{\footnotesize\textit{Keywords: Python, machine learning, data pipelines, model evaluation, Databricks, MLflow, Docker, Linux}}
...
\normalsize
\begin{itemize}
    \item Built and deployed a real-time neural-network pipeline combining natural language and categorical inputs, using transfer learning to predict high-dimensional categorical outputs.
    \item Led ML projects across energy, IoT, and manufacturing, from problem formulation to deployment.
    \item Mentored junior data scientists and delivered training in explainable AI, Git, and software architecture.
\end{itemize}

{\footnotesize\textit{Keywords: real-time ML, neural networks, production deployment, AI/ML architecture, technical leadership}}
...
{\footnotesize\textit{Keywords: deep learning, probabilistic modelling, representation learning, numerical optimisation, safety-critical domain}}
...
\normalsize
\cvitem{Technology}{Python, PyTorch, TensorFlow, SQL, Git, Linux, Docker, MLflow, Databricks, Java}
\cvitem{Methods}{Deep learning, probabilistic modelling, numerical optimisation, model evaluation}
