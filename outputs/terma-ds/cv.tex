...
\begin{itemize}
    ...
    \item Design maintainable ML architecture supporting thousands of independently trained models and reproducible evaluation.
    \item Work with technical and domain stakeholders to turn ambiguous operational needs into reliable data products.
\end{itemize}

{\footnotesize\textit{Keywords: Python, deep learning and ML, data pipelines, model evaluation, Databricks, MLflow, Docker}}
...
\begin{itemize}
    ...
    \item Led ML projects across energy, IoT, and manufacturing, from problem formulation and data analysis to deployment.
...
\normalsize
\cvitem{Technology}{Python, PyTorch, TensorFlow, scikit-learn, SQL, Git, Linux, Docker, MLflow, Databricks, Java}
\cvitem{Methods}{Statistical analysis, deep learning, representation learning, probabilistic modelling, sparse Gaussian processes, numerical optimisation, model evaluation, data visualisation}
