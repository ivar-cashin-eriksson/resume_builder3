...
Curious data scientist with <<YEARS_OF_EXPERIENCE>> years' experience applying ML across <<RELEVANT_INDUSTRIES>>. I bring a background in ML, an excellent academic record, and hands-on experience with <<RELEVANT_TECHNICAL_THEMES>>. I have a strong interest in ML, mathematics, and their application in real-world algorithmic systems.
...
\normalsize
\cvitem{Technology}{<<TECHNOLOGY_LIST>>}
...
\cvitem{Other}{<<OTHER_AWARDS_OR_ACHIEVEMENTS>>}
